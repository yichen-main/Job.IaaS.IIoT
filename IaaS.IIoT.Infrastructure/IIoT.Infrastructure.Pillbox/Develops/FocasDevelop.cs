...
public abstract class FocasDevelop
{
    ...
    public class SystemInfo
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public char[] cnc_type = Array.Empty<char>();
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public char[] mt_type = Array.Empty<char>();
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public char[] series = Array.Empty<char>();
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public char[] version = Array.Empty<char>();
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)] public char[] axes = Array.Empty<char>();
    }
    ...
    [DllImport("FWLIB64.dll", EntryPoint = "cnc_settimeout")] protected static extern short cnc_settimeout(ushort FlibHndl, int a);

    /* reset all socket connection */
    [DllImport("FWLIB64.dll", EntryPoint = "cnc_resetconnect")] protected static extern short cnc_resetconnect(ushort FlibHndl);

    /* get option state for FOCAS1/Ethernet */
    [DllImport("FWLIB64.dll", EntryPoint = "cnc_getfocas1opt")] protected static extern short cnc_getfocas1opt(ushort FlibHndl, short a, out int b);

    /* read Ethernet board information */
    [DllImport("FWLIB64.dll", EntryPoint = "cnc_rdetherinfo")] protected static extern short cnc_rdetherinfo(ushort FlibHndl, out short a, out short b);
    ...
    [DllImport("FWLIB64.dll", EntryPoint = "cnc_sdtsetchnl")] protected static extern short cnc_sdtsetchnl(ushort FlibHndl, short num, int datanum, [In] IDBSDTCHAN[] channel);
    [DllImport("FWLIB64.dll", EntryPoint = "cnc_sdtclrchnl")] protected static extern short cnc_sdtclrchnl(ushort FlibHndl);
    [DllImport("FWLIB64.dll", EntryPoint = "cnc_sdtstartsmpl")] protected static extern short cnc_sdtstartsmpl(ushort FlibHndl, short path, int seq_no);
    [DllImport("FWLIB64.dll", EntryPoint = "cnc_sdtcancelsmpl")] protected static extern short cnc_sdtcancelsmpl(ushort FlibHndl);
    [DllImport("FWLIB64.dll", EntryPoint = "cnc_sdtreadsmpl")] protected static extern short cnc_sdtreadsmpl(ushort FlibHndl, out short stat, int datanum, [In] ODBSD[] sampledata);
    [DllImport("FWLIB64.dll", EntryPoint = "cnc_sdtendsmpl")] protected static extern short cnc_sdtendsmpl(ushort FlibHndl);
    [DllImport("FWLIB64.dll", EntryPoint = "cnc_sdtread1shot")] protected static extern short cnc_sdtread1shot(ushort FlibHndl, out ushort[] data);
